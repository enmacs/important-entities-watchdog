...
**Also defined in:** `custom_components/important_entities_watchdog/manifest.json`
...
**Version:** Configured via `HA_VERSION` in `.devcontainer/devcontainer.json` (currently `2026.5.2`)
