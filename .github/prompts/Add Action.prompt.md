...
**File:** `custom_components/important_entities_watchdog/services.yaml`
...
[action_name]:
  ...
  target:
    entity:
      ...
      # OR
      integration: important_entities_watchdog
...
Create `custom_components/important_entities_watchdog/service_actions/[action_name].py`:

```python
"""[Action name] service action for Important Entities Watchdog."""
...
**File:** `custom_components/important_entities_watchdog/__init__.py`
...
**File:** `custom_components/important_entities_watchdog/const.py`
...
3. Find service action: `important_entities_watchdog.[action_name]`
...
- **Service actions directory:** `custom_components/important_entities_watchdog/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/important_entities_watchdog/services.yaml` (legacy filename)
- **Icons:** `custom_components/important_entities_watchdog/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/important_entities_watchdog/translations/*.json` under `services` key (legacy)
