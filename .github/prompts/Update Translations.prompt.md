...
- English: [#file:custom_components/important_entities_watchdog/translations/en.json]
- German: [#file:custom_components/important_entities_watchdog/translations/de.json]
