...
- Create new sensor file in `custom_components/important_entities_watchdog/sensor/`
- Inherit from `ImportantEntitiesWatchdogEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Important Entities Watchdog."""
...
class ImportantEntitiesWatchdog[SensorName]Sensor(
...
- Entity: `custom_components/important_entities_watchdog/sensor/[sensor_name].py`
- Platform: `custom_components/important_entities_watchdog/sensor/__init__.py`
- Translations: `custom_components/important_entities_watchdog/translations/*.json`
