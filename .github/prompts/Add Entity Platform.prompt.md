...
**Directory:** `custom_components/important_entities_watchdog/[platform]/`
...
```python
"""[Platform] platform for Important Entities Watchdog."""
...
from .entity import ImportantEntitiesWatchdogEntity
from .[entity_file] import ImportantEntitiesWatchdog[EntityName]
from .const import DOMAIN
from .coordinator import ImportantEntitiesWatchdogDataUpdateCoordinator
...
async def async_setup_entry(
    ...
    coordinator: ImportantEntitiesWatchdogDataUpdateCoordinator = hass.data[DOMAIN][
        entry.entry_id
    ]

    async_add_entities(
        [
            ImportantEntitiesWatchdog[EntityName](coordinator, entry),
...
```python
"""[Entity description] for Important Entities Watchdog."""
...
class ImportantEntitiesWatchdog[EntityName](
    ImportantEntitiesWatchdogEntity,
    [PlatformEntityClass],
):
    ...
    def __init__(
        self,
        coordinator: ImportantEntitiesWatchdogDataUpdateCoordinator,
        entry: ConfigEntry,
    ) -> None:
...
Add platform to `custom_components/important_entities_watchdog/manifest.json`:
...
- [ ] Entity class inherits from both `ImportantEntitiesWatchdogEntity` and platform class
...
- **Class prefix:** `ImportantEntitiesWatchdog`
- **Base entity:** `ImportantEntitiesWatchdogEntity` in `entity/base.py`
- **Coordinator:** `ImportantEntitiesWatchdogDataUpdateCoordinator`
