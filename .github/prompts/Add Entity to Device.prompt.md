...
- Inherit from `ImportantEntitiesWatchdogEntity` and platform base class
...
- Entity: `custom_components/important_entities_watchdog/[platform]/[entity_name].py`
- Platform: `custom_components/important_entities_watchdog/[platform]/__init__.py`
