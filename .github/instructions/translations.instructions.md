...
**Applies to:** `custom_components/important_entities_watchdog/translations/*.json`
...
```json
{
  "config": {
    "error": {
      ...
      "stale_auth": "[%key:component::important_entities_watchdog::config::error::invalid_auth%]"
    }
  }
}
```
