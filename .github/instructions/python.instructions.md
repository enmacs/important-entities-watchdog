...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `ImportantEntitiesWatchdog`
...
- Inherit from both platform entity and `ImportantEntitiesWatchdogEntity` (order matters)
...
from custom_components.important_entities_watchdog.sensor import async_setup_entry
...
**Config entry data:** `entry_data: ImportantEntitiesWatchdogData = hass.data[DOMAIN][entry.entry_id]`
