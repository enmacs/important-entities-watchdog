...
**Applies to:** `custom_components/important_entities_watchdog/manifest.json`
...
```json
{
  ...
  "name": "Important Entities Watchdog",
  "codeowners": ["@enmacs"],
  "config_flow": true,
  "documentation": "https://github.com/enmacs/important_entities_watchdog",
  "integration_type": "device",
  "iot_class": "cloud_polling",
  "issue_tracker": "https://github.com/enmacs/important_entities_watchdog/issues",
  "requirements": [],
  "version": "0.0.0"
}
```
