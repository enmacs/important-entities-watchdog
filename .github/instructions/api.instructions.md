...
- `ImportantEntitiesWatchdogApiClientError` (Base)
- `ImportantEntitiesWatchdogApiClientCommunicationError` (Network, timeout, HTTP errors)
- `ImportantEntitiesWatchdogApiClientAuthenticationError` (401, 403, invalid credentials)
