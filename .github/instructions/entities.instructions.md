...
- **`entity/`** - Base entity classes (inherit `ImportantEntitiesWatchdogEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, ImportantEntitiesWatchdogEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import ImportantEntitiesWatchdogEntity`
