...
- **Main code:** `custom_components/important_entities_watchdog/`
...
- `entity/` — Base entity class (`ImportantEntitiesWatchdogEntity`)
...
- Entity MRO: `(PlatformEntity, ImportantEntitiesWatchdogEntity)` — order matters
...
- Debug level: `custom_components.important_entities_watchdog: debug` in `config/configuration.yaml`
