# Getting Started with Important Entities Watchdog

This guide will help you install and set up the Important Entities Watchdog custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/enmacs/important_entities_watchdog`
6. Set category to "Integration"
7. Click "Add"
8. Find "Important Entities Watchdog" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/enmacs/important_entities_watchdog/releases)
2. Extract the `important_entities_watchdog` folder from the archive
3. Copy it to `custom_components/important_entities_watchdog/` in your Home Assistant configuration directory
...
3. Search for "Important Entities Watchdog"
...
4. Select entities from "Important Entities Watchdog"

Example entities card:

```yaml
type: entities
title: Important Entities Watchdog
entities:
...
- Report issues at [GitHub Issues](https://github.com/enmacs/important_entities_watchdog/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/enmacs/important_entities_watchdog/discussions)
