...
This document describes the technical architecture of the Important Entities Watchdog custom component for Home Assistant.

## Directory Structure

```text
custom_components/important_entities_watchdog/
...
│   ├── __init__.py          # Exports ImportantEntitiesWatchdogDataUpdateCoordinator
...
│   ├── __init__.py          # Exports ImportantEntitiesWatchdogEntity
...
- `base.py` - Main coordinator class (`ImportantEntitiesWatchdogDataUpdateCoordinator`)
...
**Key class:** `ImportantEntitiesWatchdogDataUpdateCoordinator` (exported from `coordinator/__init__.py`)
...
**Key class:** `ImportantEntitiesWatchdogApiClient`
...
- `ImportantEntitiesWatchdogConfigFlowHandler` (main flow)
- `ImportantEntitiesWatchdogOptionsFlow` (options)
...
**Key class:** `ImportantEntitiesWatchdogEntity` (in `entity/base.py`)
...
2. `ImportantEntitiesWatchdogEntity` for common functionality
...
1. Create directory: `custom_components/important_entities_watchdog/<platform>/`
2. Implement `__init__.py` with `async_setup_entry()`
3. Create entity classes inheriting from platform base + `ImportantEntitiesWatchdogEntity`
